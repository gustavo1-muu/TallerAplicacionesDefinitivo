class Tiquets:
    def __init__(self, id_tiquet, id_usuario_creador, id_usuario_asignado, 
                 id_cliente_asignado, id_tipo_tiquet, id_criticidad, 
                 id_area_destino, detalle_servicio, detalle_problema, 
                 estado, observacion):
